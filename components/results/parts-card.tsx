            ...
            <div className="space-y-2">
              {(() => {
                ...
                const cardTone = isFast
                  ? 'border border-sky-500/40 dark:border-sky-500/30 bg-sky-50/40 dark:bg-sky-500/8 ring-1 ring-sky-500/10'
                  : isBest
                  ? 'border border-brand-500/40 dark:border-brand-500/30 bg-brand-50/50 dark:bg-brand-500/8 ring-1 ring-brand-500/10'
                  : 'border border-slate-200/60 dark:border-border bg-slate-50 dark:bg-surface/85';
                return (
